...
from openapi_client.models.check_dns_data import CheckDNSData  # noqa: E501

class TestCheckDNSData(unittest.TestCase):
    """CheckDNSData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckDNSData:
        """Test CheckDNSData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckDNSData`
        """
        model = CheckDNSData()  # noqa: E501
        if include_optional:
            return CheckDNSData(
