...
from openapi_client.models.mail_server import MailServer  # noqa: E501

class TestMailServer(unittest.TestCase):
    """MailServer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailServer:
        """Test MailServer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailServer`
        """
        model = MailServer()  # noqa: E501
        if include_optional:
            return MailServer(
                status = '',
                data = openapi_client.models.mail_server_data.MailServer_data(
