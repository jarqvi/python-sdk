...
from openapi_client.models.mail_server_response import MailServerResponse  # noqa: E501

class TestMailServerResponse(unittest.TestCase):
    """MailServerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailServerResponse:
        """Test MailServerResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailServerResponse`
        """
        model = MailServerResponse()  # noqa: E501
        if include_optional:
    ...
    def testMailServerResponse(self):
        """Test MailServerResponse"""
