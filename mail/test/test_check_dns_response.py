...
from openapi_client.models.check_dns_response import CheckDNSResponse  # noqa: E501

class TestCheckDNSResponse(unittest.TestCase):
    """CheckDNSResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckDNSResponse:
        """Test CheckDNSResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckDNSResponse`
        """
        model = CheckDNSResponse()  # noqa: E501
        if include_optional:
            return CheckDNSResponse(
