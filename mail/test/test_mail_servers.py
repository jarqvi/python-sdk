...
from openapi_client.models.mail_servers import MailServers  # noqa: E501

class TestMailServers(unittest.TestCase):
    """MailServers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailServers:
        """Test MailServers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailServers`
        """
        model = MailServers()  # noqa: E501
        if include_optional:
            return MailServers(
                status = '',
                data = openapi_client.models.mail_servers_data.MailServers_data(
                    mail_servers = [
