...
from openapi_client.models.check_dns_response_dns_setup import CheckDNSResponseDnsSetup  # noqa: E501

class TestCheckDNSResponseDnsSetup(unittest.TestCase):
    """CheckDNSResponseDnsSetup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckDNSResponseDnsSetup:
        """Test CheckDNSResponseDnsSetup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckDNSResponseDnsSetup`
        """
        model = CheckDNSResponseDnsSetup()  # noqa: E501
        if include_optional:
            return CheckDNSResponseDnsSetup(
    ...
    def testCheckDNSResponseDnsSetup(self):
        """Test CheckDNSResponseDnsSetup"""
