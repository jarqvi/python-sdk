...
from openapi_client.models.create_key import CreateKey  # noqa: E501
...
class TestCreateKey(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateKey:
        """Test CreateKey
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateKey`
        """
        model = CreateKey()  # noqa: E501
        if include_optional:
            return CreateKey(
                buckets = [
                    None
