...
class TestCreateKey201Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateKey201Response:
        ...
        """
        model = CreateKey201Response()  # noqa: E501
        if include_optional:
            return CreateKey201Response(
                status = '',
                data = openapi_client.models.create_key_201_response_data.createKey_201_response_data(
                    access_key = '', 
                    secret_key = '', )
            )
        else:
    ...
    def testCreateKey201Response(self):
        """Test CreateKey201Response"""
