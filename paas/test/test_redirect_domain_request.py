...
from openapi_client.models.redirect_domain_request import RedirectDomainRequest  # noqa: E501

class TestRedirectDomainRequest(unittest.TestCase):
    """RedirectDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RedirectDomainRequest:
        """Test RedirectDomainRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RedirectDomainRequest`
        """
        model = RedirectDomainRequest()  # noqa: E501
        if include_optional:
            return RedirectDomainRequest(
    ...
    def testRedirectDomainRequest(self):
        """Test RedirectDomainRequest"""
