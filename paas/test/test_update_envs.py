...
from openapi_client.models.update_envs import UpdateEnvs  # noqa: E501

class TestUpdateEnvs(unittest.TestCase):
    """UpdateEnvs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateEnvs:
        """Test UpdateEnvs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateEnvs`
        """
        model = UpdateEnvs()  # noqa: E501
        if include_optional:
            return UpdateEnvs(
                project = '',
                variables = [
                    openapi_client.models.update_envs_variables_inner.Update_envs_variables_inner(
                        key = '', 
                        value = '', )
                    ]
            )
