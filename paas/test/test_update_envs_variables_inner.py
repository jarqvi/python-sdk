...
from openapi_client.models.update_envs_variables_inner import UpdateEnvsVariablesInner  # noqa: E501

class TestUpdateEnvsVariablesInner(unittest.TestCase):
    """UpdateEnvsVariablesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateEnvsVariablesInner:
        """Test UpdateEnvsVariablesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateEnvsVariablesInner`
        """
        model = UpdateEnvsVariablesInner()  # noqa: E501
        if include_optional:
            return UpdateEnvsVariablesInner(
                key = '',
                value = ''
            )
        else:
    ...
    def testUpdateEnvsVariablesInner(self):
        """Test UpdateEnvsVariablesInner"""
