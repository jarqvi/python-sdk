...
from openapi_client.models.check_domain import CheckDomain  # noqa: E501

class TestCheckDomain(unittest.TestCase):
    """CheckDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckDomain:
        """Test CheckDomain
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckDomain`
        """
        model = CheckDomain()  # noqa: E501
        if include_optional:
            return CheckDomain(
                domain = openapi_client.models.check_domain_domain.CheckDomain_domain(
                    _id = '', 
                    user = '', 
                    name = '', 
                    type = '', 
