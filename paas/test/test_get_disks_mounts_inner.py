...
from openapi_client.models.get_disks_mounts_inner import GetDisksMountsInner  # noqa: E501

class TestGetDisksMountsInner(unittest.TestCase):
    """GetDisksMountsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDisksMountsInner:
        """Test GetDisksMountsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDisksMountsInner`
        """
        model = GetDisksMountsInner()  # noqa: E501
        if include_optional:
            return GetDisksMountsInner(
                name = '',
                mounted_to = ''
            )
        else:
    ...
    def testGetDisksMountsInner(self):
        """Test GetDisksMountsInner"""
