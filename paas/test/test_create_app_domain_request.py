...
from openapi_client.models.create_app_domain_request import CreateAppDomainRequest  # noqa: E501

class TestCreateAppDomainRequest(unittest.TestCase):
    """CreateAppDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAppDomainRequest:
        """Test CreateAppDomainRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAppDomainRequest`
        """
        model = CreateAppDomainRequest()  # noqa: E501
        if include_optional:
            return CreateAppDomainRequest(
                name = '',
                project = '',
                type = 'PROJECT'
            )
    ...
    def testCreateAppDomainRequest(self):
        """Test CreateAppDomainRequest"""
