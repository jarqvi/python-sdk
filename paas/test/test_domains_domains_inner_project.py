...
from openapi_client.models.domains_domains_inner_project import DomainsDomainsInnerProject  # noqa: E501

class TestDomainsDomainsInnerProject(unittest.TestCase):
    """DomainsDomainsInnerProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainsDomainsInnerProject:
        """Test DomainsDomainsInnerProject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainsDomainsInnerProject`
        """
        model = DomainsDomainsInnerProject()  # noqa: E501
        if include_optional:
            return DomainsDomainsInnerProject(
                id = '',
                project_id = ''
            )
        else:
    ...
    def testDomainsDomainsInnerProject(self):
        """Test DomainsDomainsInnerProject"""
