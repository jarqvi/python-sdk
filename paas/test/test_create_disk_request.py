...
from openapi_client.models.create_disk_request import CreateDiskRequest  # noqa: E501

class TestCreateDiskRequest(unittest.TestCase):
    """CreateDiskRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDiskRequest:
        """Test CreateDiskRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDiskRequest`
        """
        model = CreateDiskRequest()  # noqa: E501
        if include_optional:
    ...
    def testCreateDiskRequest(self):
        """Test CreateDiskRequest"""
