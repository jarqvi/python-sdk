...
from openapi_client.models.check_domain_domain_project import CheckDomainDomainProject  # noqa: E501

class TestCheckDomainDomainProject(unittest.TestCase):
    """CheckDomainDomainProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckDomainDomainProject:
        """Test CheckDomainDomainProject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckDomainDomainProject`
        """
        model = CheckDomainDomainProject()  # noqa: E501
        if include_optional:
            return CheckDomainDomainProject(
                id = '',
                project_id = ''
            )
        else:
    ...
    def testCheckDomainDomainProject(self):
        """Test CheckDomainDomainProject"""
