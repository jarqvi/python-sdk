...
from openapi_client.models.turn_app_request import TurnAppRequest  # noqa: E501

class TestTurnAppRequest(unittest.TestCase):
    """TurnAppRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TurnAppRequest:
        """Test TurnAppRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TurnAppRequest`
        """
        model = TurnAppRequest()  # noqa: E501
        if include_optional:
            return TurnAppRequest(
                scale = 1.337
            )
        else:
            return TurnAppRequest(
