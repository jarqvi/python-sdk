...
from openapi_client.models.enable_ssl_request import EnableSslRequest  # noqa: E501

class TestEnableSslRequest(unittest.TestCase):
    """EnableSslRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnableSslRequest:
        """Test EnableSslRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnableSslRequest`
        """
        model = EnableSslRequest()  # noqa: E501
        if include_optional:
