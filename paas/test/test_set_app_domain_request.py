...
from openapi_client.models.set_app_domain_request import SetAppDomainRequest  # noqa: E501

class TestSetAppDomainRequest(unittest.TestCase):
    """SetAppDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetAppDomainRequest:
        """Test SetAppDomainRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetAppDomainRequest`
        """
        model = SetAppDomainRequest()  # noqa: E501
        if include_optional:
            return SetAppDomainRequest(
                domain_id = '',
                project_id = ''
            )
        else:
    ...
    def testSetAppDomainRequest(self):
        """Test SetAppDomainRequest"""
