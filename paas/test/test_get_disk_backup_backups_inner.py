...
from openapi_client.models.get_disk_backup_backups_inner import GetDiskBackupBackupsInner  # noqa: E501

class TestGetDiskBackupBackupsInner(unittest.TestCase):
    """GetDiskBackupBackupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDiskBackupBackupsInner:
        """Test GetDiskBackupBackupsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDiskBackupBackupsInner`
        """
        model = GetDiskBackupBackupsInner()  # noqa: E501
        if include_optional:
            return GetDiskBackupBackupsInner(
                name = '',
                last_modified = '',
                etag = '',
                size = 1.337
    ...
    def testGetDiskBackupBackupsInner(self):
        """Test GetDiskBackupBackupsInner"""
